...
namespace mwl {
    ...
    public:
        ...
        static int32_t ParsePath(const String &path, String *pDirName, String *pBaseName);
        static int32_t ParsePath(const String &path, String *pDirName, String *pFileName, String *pExt);
        static String MakePath(const String &dirName, const String &fileName, const String &ext);
        static String MakePath(const String &dirName, const String &baseName);
    };
